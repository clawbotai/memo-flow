...
UT[src/hooks/use-transcription-config.ts<br/>前端配置钩子]
TS[src/types/index.ts<br/>类型定义]
end
subgraph "UI 组件"
WS[src/components/whisper-settings.tsx<br/>设置界面]
end
subgraph "API 路由"
...
- [whisper-settings.tsx:1-800](file://src/components/whisper-settings.tsx#L1-L800)
- [use-transcription-config.ts:1-149](file://src/hooks/use-transcription-config.ts#L1-L149)
...
- [whisper-settings.tsx:211-800](file://src/components/whisper-settings.tsx#L211-L800)
...
UT[use-transcription-config.ts]
TS[types/index.ts]
end
subgraph "界面层"
